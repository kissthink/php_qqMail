...
class Smtp {
	...
	public function _set_error_message($msg, $val = '')
	{
		...
		$lang_key = substr($msg, 5);
		if (substr($msg, 0, 5) != 'lang:' || FALSE === array_key_exists($lang_key, $lang))
		{
			$this->_debug_msg[] = str_replace('%s', $val, $msg)."<br />";
		}
		else
		{
			$this->_debug_msg[] = str_replace('%s', $val, $lang[$lang_key])."<br />";
		}
	}
